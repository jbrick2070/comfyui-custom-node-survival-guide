...
An AI-agent QA harness for ComfyUI custom-node authoring. v2.1 — 299 bible entries + LLM round-robin consult addon.
...
299 bible entries across 12 phases; the pytest suite encodes the static-
